...
2.  Based on the user's choices from menus: 
3. display information about the Text: 
   * length, 
   * number of spaces, 
...
4. Present the current status of selected Text in the TextBox at all times, showing the 
   * selection length, 
   * selection start, 
   * selection end, 
